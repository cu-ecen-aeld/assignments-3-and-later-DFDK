...
void test_validate_my_username()
{
     ...
     */
    const char *exp_username = my_username();
    const char *act_username = malloc_username_from_conf_file();
    TEST_ASSERT_EQUAL_STRING_MESSAGE(exp_username, act_username, "AESD students, please fix me!");
}
